...
def main():
    ...
    # Step 1: Get DATABASE_URL from .env
    ...
    sql = "ALTER TABLE students ADD COLUMN IF NOT EXISTS device_id TEXT;"
    ...
    print("\nMigration done! device_id column added and server restarted.")
    client.close()
