...
export interface WhyChooseMeTabProps {
...
export const WhyChooseMeTab: React.FC<WhyChooseMeTabProps> = ({
  formData,
  handleChange,
  handleFileUpload,
  isUploading,
  ...
  return (
    <div className="space-y-5">
      <h3 className="text-lg font-bold text-foreground">
        إعدادات سكن "ليه تختارني" (Why Choose Me)
      </h3>
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            onChange={(e) =>
              handleChange(SETTINGS_KEYS.WHY_CHOOSE_ME_BG_URL, e.target.value)
            }
          ...
          <div className="relative flex-shrink-0">
            <input
              ...
              accept="image/*"
              onChange={(e) =>
                handleFileUpload(e, SETTINGS_KEYS.WHY_CHOOSE_ME_BG_URL)
              }
