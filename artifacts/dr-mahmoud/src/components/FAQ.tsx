...
const defaultFaqs = [
  ...
  {
    q: "ما هي المراحل التعليمية المستهدفة في كورس البرمجة؟",
    a: "الكورسات مخصصة لطلاب الثانوية العامة والبكالوريا (الصف الأول والثاني والثالث الثانوي)، بالإضافة لطلاب كليات حاسبات ومعلومات والهندسة والجامعات، مع مسار تأسيسي مخصص للمبتدئين في لغات Python و C++ والتفكير المنطقي."
  },
  {
  ...
  },
  {
    ...
    a: "الأسلوب عملي 100% — مفيش حفظ ولا تلقين. كل طالب بيطلع بمشروع حقيقي في إيده. الشرح بسيط ومنظم ومناسب لكل المستويات من البكالوريا حتى الجامعة. د. محمود حاصل على ماجستير نظم معلومات وعنده خبرة أكاديمية وتدريبية متخصصة."
  },
  {
